...
module.exports = {
  ...
  async create(req, res) {
    try {
      ...
      const categoria = await Recipe.categoriaName();

      return res.render("admin/recipes/create", { chefs, categoria });
    } catch (err) {
      console.error(err);
    }
  },
  async post(req, res) {
    try {
      let { chef, categoria, title, ingredients, preparation, information } = req.body;
  ...
  async edit(req, res) {
    try {
      ...
      return res.render("admin/recipes/edit", { recipe, chefs,categoria });
    } catch (err) {
      console.error(err);
    }
  },
  async put(req, res) {
    try {
      let { categoria,chef, title, ingredients, preparation, information } = req.body;
